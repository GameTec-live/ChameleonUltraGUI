...
bool mfClassicSakOffsetVisibleInEdit(TagType type, List<Uint8List> data) =>
    isMifareClassic(type) && data.isNotEmpty && data[0].isNotEmpty;

bool mfClassicSakOffsetVisibleInWrite(TagType type, List<Uint8List> data) =>
    isMifareClassic(type) && (data.isEmpty || data[0].isEmpty);

bool? mfClassicSakOffsetFromUidHex(String uidHex) {
...
bool? mfClassicSakOffsetFromData(
