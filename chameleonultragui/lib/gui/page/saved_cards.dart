  ...
  if (duplicate != null) {
    ...
    final action = await showDialog<String>(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          localizations.card_uid_already_exists(duplicate.name),
        ),
        actions: [
          ElevatedButton(
...
class SavedCardsPageState extends State<SavedCardsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(localizations.saved_cards)),
      body: Column(
        children: [
          Expanded(
            child: Card(
                            ...
                            Expanded(
                              child: ElevatedButton(
                                onPressed: () async {
                                  ...
                                  if (result != null) {
                                    var contents = await platformFileReadBytes(
                                      result,
                                    );
                                    try {
                            ...
                            children: [
                              ...
                              IconButton(
                                onPressed: () async {
                                  ...
                                  appState.sharedPreferencesProvider.setCards(
                                    output,
                                  );
                                  appState.changesMade();
                                },
