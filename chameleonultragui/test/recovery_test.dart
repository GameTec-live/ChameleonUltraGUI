...
void main() {
  test('Test darkside', () async {
    ...
    darkside.items.add(DarksideItemDart(
        nt1: 913032415, ks1: BigInt.parse('216745674933338888'), par: BigInt.from(0), nr: 0, ar: 0));
    darkside.items.add(DarksideItemDart(
        nt1: 913032415, ks1: BigInt.parse('1010230244403446283'), par: BigInt.from(0), nr: 1, ar: 0));
